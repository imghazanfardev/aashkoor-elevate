    ...
    handlers: {
      GET: async () => {
        const entries: SitemapEntry[] = [
          ...
          { path: "/services/hvac", changefreq: "monthly", priority: "0.85" },
          { path: "/services/agriculture", changefreq: "monthly", priority: "0.85" },
          { path: "/services/industrial-supply", changefreq: "monthly", priority: "0.85" },
